...
public class TestServerInfo {
        ...
        public static void createServerRecord() {
            ...
            ServerInfo serverInfo = new ServerInfo(1337L, "127.0.0.1", 3000, 4000, 3);
            ...
            try {
                ...
                System.out.println("Attempting to add client 4 (should fail and trigger a ChatServerFullException)");
                serverInfo.addClient();
            ...
            System.out.println("Status after marking inactive: " + serverInfo.getStatus());
            try {
